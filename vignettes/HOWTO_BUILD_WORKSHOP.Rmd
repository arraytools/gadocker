...
author: arraytools^[arraytools@gmail.com]
...
```
git clone https://github.com/arraytools/gadocker MYPKGDIR
```
...
In the DESCRIPTION file, update the URL: to the website url eg https://arraytools.github.io/gadocker/
...
```yaml
     - uses: docker/build-push-action@v1
        with:
          ...
          repository: arraytools/gadocker
          tag_with_ref: true
          tag_with_sha: true
          tags: latest
```
